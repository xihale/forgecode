...
/// * `show_tips` - If true, appends version info, command tips, and the zsh
///   plugin encouragement message below the banner.
///
/// # Environment Variables
///
/// * `FORGE_BANNER` - Optional custom banner text to display instead of the
///   default
pub fn display(cli_mode: bool, show_tips: bool) -> io::Result<()> {
